...
class LandingPage(BasePage):
    ...
    _community_forum_selector = (By.CSS_SELECTOR, '#gatsby-focus-wrapper > div > header.gh-head.false > nav > div.gh-navbar-left > div:nth-child(4) > div > div > ul > li:nth-child(3) > a')

    def click_resources(self):
        self.click(self._resource_selector)

    def click_community(self):
        self.click(self._community_forum_selector)
